...
ACCOUNT="UCX7DY7WCKY3LHSPFPYER5IBF7BEFUPYTJJNZ3HAPEBFZXFFHYDBSBKRHE"
...
APPID=$(${gcmd} app create --creator ${ACCOUNT} --approval-prog ./reward_fund.teal --global-byteslices 3 --global-ints 1 --local-byteslices 0 --local-ints 1 --app-arg "addr:"${ACCOUNT} --clear-prog ./reward_fund_close.teal | grep Created | awk '{ print $6 }')
